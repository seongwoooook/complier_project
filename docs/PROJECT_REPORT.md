...
│  • Recognizes keywords, IDs, numbers, operators             │
...
│  • Detects syntax errors and recovery                       │
└─────────────────────────────────────────────────────────────┘
                              │
...
│  • Traverses AST via Tree-walking                           │
│  • Manages Scope with Environment                           │
│  • Executes built-in & user-defined functions               │
